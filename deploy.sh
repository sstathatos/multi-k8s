...
kubectl set image deployments/client-deployment server=sstathatos/multi-client:$SHA
kubectl set image deployments/worker-deployment server=sstathatos/multi-worker:$SHA
